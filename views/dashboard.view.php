    ...
    <div id="content" class="grow">
        ...
        <div class="flex flex-col gap-6 p-7">
            <div id="sales" class="flex gap-3">
                <div id="daily" class="shadow-lg bg-white rounded-lg w-1/4 p-5 flex justify-between">
                    <div id="sales-desc" class="flex gap-2 items-center">
                        ...
                        <h3 class="font-medium text-teal-700"><span class="text-2xl font-semibold">Daily</span><br>Sales</h3>
                    </div>
                    <div id="sales-num" class="text-2xl font-semibold text-slate-700">₱ 80</div>
                </div>
                <div id="weekly" class="shadow-lg bg-white rounded-lg w-1/4 p-5 flex justify-between">
                    <div id="sales-desc" class="flex gap-2 items-center">
                        <span class="icon flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 text-teal-700">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 18 9 11.25l4.306 4.306a11.95 11.95 0 0 1 5.814-5.518l2.74-1.22m0 0-5.94-2.281m5.94 2.28-2.28 5.941" />
                        ...
                        <h3 class="font-medium text-teal-700"><span class="text-2xl font-semibold">Weekly</span><br>Sales</h3>
                    </div>
                    <div id="sales-num" class="text-2xl font-semibold text-slate-700">₱ 80</div>
                </div>
                <div id="yearly" class="shadow-lg bg-white rounded-lg w-1/4 p-5 flex justify-between">
                    <div id="sales-desc" class="flex gap-2 items-center">
                        <span class="icon flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 text-teal-700">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 18 9 11.25l4.306 4.306a11.95 11.95 0 0 1 5.814-5.518l2.74-1.22m0 0-5.94-2.281m5.94 2.28-2.28 5.941" />
                        ...
                        <h3 class="font-medium text-teal-700"><span class="text-2xl font-semibold">Yearly</span><br>Sales</h3>
                    </div>
                    <div id="sales-num" class="text-2xl font-semibold text-slate-700">₱ 80</div>
                </div>
                <div id="yearly" class="shadow-lg bg-white rounded-lg w-1/4 p-5 flex justify-between">
                    <div id="sales-desc" class="flex gap-2 items-center">
                        ...
                        <h3 class="font-medium text-teal-700"><span class="text-2xl font-semibold">Cashier of the Year</span></h3>
                    </div>
                </div>
            </div>

            <div class="flex gap-3">
                <div id="most-popular" class="bg-white p-5 rounded-lg shadow-lg w-1/2">
                ...
                <div id="sales" class="bg-white p-5 rounded-lg shadow-lg w-1/2">
                    <h3 class="text-2xl font-semibold mb-4 border-b-[1px] border-stone-200 pb-4 text-teal-700">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 inline mr-[5px]">
